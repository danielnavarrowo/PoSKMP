...
fun SyncSettingsSection(
    ...
    Column(
        ...
        Column(verticalArrangement = Arrangement.spacedBy(2.dp)) {
            ...
            // Card 2: Prefijo de Terminal / Folio (Bottom)
            Card(
                colors = CardDefaults.cardColors(
                    containerColor = MaterialTheme.colorScheme.surfaceContainer
                ),
                ...
                Column(modifier = Modifier.padding(20.dp)) {
                    ...
                    Spacer(modifier = Modifier.height(2.dp))
                    Text(
                        text = "Identificador opcional que se antepone al folio del ticket (ej. C1-1001) para reconocer en qué caja se cobró.",
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                    Spacer(modifier = Modifier.height(16.dp))
        ...
        // --- Categoría 2: Sincronización en la Nube (Supabase) ---
        Row(
        ...
        Column(verticalArrangement = Arrangement.spacedBy(2.dp)) {
            ...
            // Card 2: Toggle Sincronización automática (Middle - Individual Toggle Card)
            Card(
                colors = CardDefaults.cardColors(
                    containerColor = MaterialTheme.colorScheme.surfaceContainer
                ),
            ...
            // Card 3: Acciones y Estado de Sincronización (Bottom)
            Card(
                colors = CardDefaults.cardColors(
                    containerColor = MaterialTheme.colorScheme.surfaceContainer
                ),
                ...
                Column(modifier = Modifier.padding(20.dp)) {
                    ...
                    Spacer(modifier = Modifier.height(2.dp))
                    Text(
                        text = "Ejecuta sincronizaciones manuales o consulta la bitácora de operaciones en el servidor.",
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                    Spacer(modifier = Modifier.height(16.dp))
